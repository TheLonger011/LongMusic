...
func (s *PlaylistService) GetByID(playlistID int64) (domain.Playlist, error) {
...
func (s *PlaylistService) Public(playlistID int64) error {
	return s.repo.Public(playlistID)
}

func (s *PlaylistService) Private(playlistID int64) error {
	return s.repo.Private(playlistID)
}

func (s *PlaylistService) SearchPublic(query string) ([]domain.Playlist, error) {
	return s.repo.SearchPublic(query)
}

func (s *PlaylistService) Delete(playlistID int64) error {
